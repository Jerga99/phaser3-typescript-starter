...
export default class PlayScene extends BaseScene {
  ...
  pipes: Phaser.Physics.Arcade.Group = null;
  pauseEvent: any;
  ...
  placePipe(uPipe, lPipe) {
    ...
    const pipeVerticalDistance = Phaser.Math.Between(difficulty.pipeVerticalDistanceRange[0], difficulty.pipeVerticalDistanceRange[1]);
    const pipeVerticalPosition = Phaser.Math.Between(0 + 20, this.config.height - 20 - pipeVerticalDistance);
    const pipeHorizontalDistance = Phaser.Math.Between(difficulty.pipeHorizontalDistanceRange[0], difficulty.pipeHorizontalDistanceRange[1]);
  ...
  getRightMostPipe() {
    ...
    this.pipes.getChildren().forEach(function(pipe: Phaser.Physics.Arcade.Sprite) {
